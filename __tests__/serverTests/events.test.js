  ...
  chai.request(server)
    ...
    .end((err, res) => {
      ...
      expect(res.body).toContainObject({
        enabled: false, id: 8, sportId: 8, sportName: 'WNBA',
      });
      expect(res.body).toContainObject({
        id: 6, sportId: 6, sportName: 'NHL', enabled: true,
      });
      expect(res.body).toContainObject({
        id: 2, sportId: 5, sportName: 'NCAA Men\'s Basketball', enabled: true,
      });
      expect(res.body).toContainObject({
        id: 3, sportId: 4, sportName: 'NBA', enabled: true,
      });
      expect(res.body).toContainObject({
        id: 9, sportId: 9, sportName: 'CFL', enabled: false,
      });
      expect(res.body).toContainObject({
        id: 4, sportId: 1, sportName: 'NCAA Football', enabled: true,
      });
      expect(res.body).toContainObject({
        id: 1, sportId: 2, sportName: 'NFL', enabled: true,
      });
      expect(res.body).toContainObject({
        id: 7, sportId: 7, sportName: 'UFC/MMA', enabled: false,
      });
      expect(res.body).toContainObject({
        id: 7, sportId: 7, sportName: 'UFC/MMA', enabled: false,
      });
      expect(res.body).toContainObject({
        id: 5, sportId: 3, sportName: 'MLB', enabled: true,
      });
      done();
    });
});
